...
@section('content')
<h3 class="text-bold">Edit Artikel</h3>
      ...
      <form action="{{ route('artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6 mt-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" class="form-control" id="kategori" name="kategori"
              value="{{ old('kategori', $artikel->kategori) }}" placeholder="Masukkan Kategori Artikel (opsional)">
          </div>
        </div>
        ...
        <div class="mb-6">
          ...
          @if($artikel->thumbnail)
            <div class="mt-2">
              ...
              <img src="{{ asset('storage/' . $artikel->thumbnail) }}" alt="Thumbnail" width="150" class="rounded">
            </div>
          @endif
        </div>
        ...
        <div class="mb-6">
          ...
          <div class="input-group input-group-merge">
            ...
            <textarea class="form-control" id="ringkasan" name="ringkasan"
              rows="4">{{ old('ringkasan', $artikel->ringkasan) }}</textarea>
          </div>
        </div>
        ...
        <div class="mb-6">
          ...
          <div class="input-group input-group-merge">
            ...
            <textarea class="form-control" id="isi" name="isi" rows="10" required>{{ old('isi', $artikel->isi) }}</textarea>
          </div>
        </div>
        ...
        <div class="mb-6">
          ...
          <div class="input-group input-group-merge">
            ...
            <textarea class="form-control" id="meta_description" name="meta_description"
              rows="3">{{ old('meta_description', $artikel->meta_description) }}</textarea>
          </div>
        </div>
        ...
        <div class="mb-6">
          ...
          <div class="input-group input-group-merge">
            ...
            <select class="form-select" id="is_published" name="is_published">
              <option value="0" {{ $artikel->is_published == 0 ? 'selected' : '' }}>Draft</option>
              <option value="1" {{ $artikel->is_published == 1 ? 'selected' : '' }}>Publish</option>
            </select>
          </div>
        </div>
