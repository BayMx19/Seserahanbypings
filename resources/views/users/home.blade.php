    ...
    <div class="row">
        ...
        <div class="col col_5 col_desktop-12 order-desktop-1">
            <div class="main-container">
                ...
                <a href="#products" style="text-decoration: none !important;" type="button"
                    class="btn button-landing">Pesan Sekarang</a>
            </div>
        </div>
    </div>
    </div>
...
<section id="advantage" class="section">
    <div class="container">
        ...
        <div class="col text-center" style="margin-bottom: 50px;">
            <h2 class="h2 title fw-bold" style="margin: 0 !important;">Kenapa Memilih <span
                    class="text-primary text-bold text-blue">Seserahan byPings?</span></h2>
        ...
        <div class="row">
            <div class="dignity-item col col_4 col_mob-12">
                <div class="dignity-block text-center p-4 shadow rounded bg-white h-100">
                    <div class="icon-wrapper mx-auto mb-3">
                        <img src="{{ asset('assets/users/images/icons/custom.png') }}" alt="Desain Custom"
                            class="img-icon">
                    </div>
            ...
            <div class="dignity-item col col_4 col_mob-12">
                <div class="dignity-block text-center p-4 shadow rounded bg-white h-100">
                    <div class="icon-wrapper mx-auto mb-3">
                        <img src="{{ asset('assets/users/images/icons/fast-delivery.png') }}" alt="Desain Custom"
                            class="img-icon">
                    </div>
            ...
            <div class="dignity-item col col_4 col_mob-12">
                <div class="dignity-block text-center p-4 shadow rounded bg-white h-100">
                    <div class="icon-wrapper mx-auto mb-3">
                        <img src="{{ asset('assets/users/images/icons/variant.png') }}" alt="Desain Custom"
                            class="img-icon">
                    </div>
...
<section id="experiences" class="section">
    <div class="container">
        <div class="row">
            ...
            <!-- Konten Deskripsi -->
            <div class="col col_6 col_desktop-12">
                <h2 class="h2 emotional-title mb-4 text-bold">Seserahan Bukan Sekadar Hadiah, Tapi Simbol Kasih & Doa
                </h2>
                    ...
                    <div class="emotional-item mb-4">
                        <div class="emotional-block d-flex">
                            ...
                            <div class="emotional-info">
                                ...
                                <p class="text-muted">Setiap isi seserahan punya simbol dan harapan tersendiri untuk
                                    pasangan.</p>
                            </div>
                        </div>
                    </div>
                    <div class="emotional-item mb-4">
                        <div class="emotional-block d-flex">
                            ...
                            <div class="emotional-info">
                                ...
                                <p class="text-muted">Kami percaya, visual yang indah menciptakan kenangan yang abadi.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="emotional-item">
                        <div class="emotional-block d-flex">
                            ...
                            <div class="emotional-info">
                                ...
                                <p class="text-muted">Dari konsep hingga eksekusi, kami bantu wujudkan seserahan
                                    impianmu.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col col_6 col_desktop-12">
                <div class="description-container">
                    <div class="wysiwyg">
                        <h3 class="h3 title fw-bold mb-4">Tentang <span
                                class="text-primary text-bold text-blue">Seserahan byPings</span></h3>
                        <p><b class="text-blue">Seserahan byPings</b> hadir untuk membantu kamu menyiapkan seserahan
                            yang elegan, penuh makna, dan sesuai dengan harapan. Kami percaya bahwa setiap seserahan
                            bukan hanya sekadar hadiah, tapi bentuk cinta dan doa terbaik untuk pasangan.</p>
                        <p>Dengan desain yang bisa dikustom, pilihan paket lengkap, dan pelayanan profesional, kami siap
                            menemani setiap momen spesialmu menjadi lebih berkesan.</p>
                        ...
                        <div class="photo-item description-photo-item-1">
                            <div class="photo-img">
                                <div class="photo-img__block rounded shadow">
                                    <img src="{{ asset('assets/logo/logo.png') }}" alt="Seserahan byPings"
                                        class="img-fluid rounded">
                                </div>
                            </div>
                            <div class="photo-info wysiwyg">
                                <p class="text-muted small mt-2">"Karena momen spesial pantas mendapatkan kemasan yang
                                    istimewa."</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row" style="justify-content: center !important; align-items:center !important;">
            ...
            <div class=" temukan-kami-map">
                <div class="col-12" style="width: 100%; align-item: center !important;">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d2346.7442489700748!2d114.27550098043753!3d-8.427404453796097!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOMKwMjUnMzMuMyJTIDExNMKwMTYnMzguMyJF!5e0!3m2!1sen!2sid!4v1751963900461!5m2!1sen!2sid"
...
'id' => $item->id,
'judul' => $item->judul,
'konten' => \Illuminate\Support\Str::limit(strip_tags($item->konten), 100),
...
<script>
            ...
            <div class="position-relative">
                ...
                <div class="carousel-caption d-none d-md-block" style="bottom: 20%; left: 10%; right: 10%; text-align: left;">
                    <div class="bg-dark bg-opacity-75 p-4 rounded" style="max-width: 600px;">
                        ...
                        <a href="{{ route('user.artikel.index') }}" class="btn btn-primary btn-lg px-4 py-2">Baca Selengkapnya</a>
                    </div>
                </div>
                <div class="carousel-caption d-md-none" style="bottom: 10%; left: 5%; right: 5%;">
                    <div class="bg-dark bg-opacity-75 p-3 rounded">
                        ...
                        <a href="{{ route('user.artikel.index') }}" class="btn btn-primary btn-sm">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
        </div>`;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        renderArticleSlides(); // render artikel
