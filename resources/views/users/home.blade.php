                            ...
                            <div class="swiper-slide slider-item post-slider__item">
                                ...
                                <div class="display-flex justify-between align-center flex-wrap">
                                        <button 
                                            ...
                                            data-prices='@json($item->harga->map(fn($h) => ["label" => $h->kategori, "value" => $h->harga]))'
    ...
    <div class="modal-content p-4">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <div class="mb-3">
            <label for="modalSelectHarga" class="form-label">Pilih Layanan</label>
            <select class="form-select" id="modalSelectHarga">
              <!-- Diisi dari JS -->
            </select>
          </div>
          ...
          <button class="btn btn-primary w-100 mt-3">Tambahkan ke Keranjang</button>
        </div>
      </div>
    </div>
  </div>
