            ...
            <div class="header-nav">
                ...
                <div class="header-nav__container">
                    ...
                    <div class="header-nav__info">
                        <a href="tel:9999912345678">Masuk</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section id="products" class="section section-main__post">
            <div class="container">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-3 mb-4">
                    <button class="btn btn-outline-primary active" data-tab="seserahan">Seserahan</button>
                    <button class="btn btn-outline-primary" data-tab="mahar">Mahar</button>
                    <button class="btn btn-outline-primary" data-tab="box">Box</button>
                </div>
                        ...
                        <div class="swiper-wrapper post-slider__wrapper">
                            <div class="swiper-slide slider-item post-slider__item">
                                <div class="post-slider__image">
                                    <img src="{{ asset('assets/users/images/content/main-page-7.jpg')}}" alt="main-page-7">
                                </div>
