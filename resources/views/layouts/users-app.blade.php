...
<head>
    ...
    <style>
        ...
        .select-layanan {
            ...
            /* Ini bikin garis seperti input biasa */
    ...
    <div id="wrapper" class="wrapper">
        ...
        <header id="header" class="header">
            <div class="container">
                <!-- logo -->
                <div class="site-logo">
                    <a href="{{ url('/home') }}" class="site-logo__link">
                        <picture>
                            ...
                            <div class="header-nav__menu">
                                <nav class="nav">
                                    <ul class="nav__list">
                                        ...
                                        <li class="nav__item">
                                            <a href="{{ route('user.gallery.index') }}" class="nav__link">Gallery</a>
                                        </li>
                                        <li class="nav__item">
                                            <a href="{{ route('user.artikel.index') }}" class="nav__link">Artikel</a>
                                        </li>
                                    </ul><!-- //nav__list -->
                            ...
                            <div class="col col_6 col_desktop-6 col_mob-12">
                                <ul class="contact-list icon-list">
                                    ...
                                    <li class="contact-item icon-text icon-position-right">
                                        ...
                                        <svg class="icon" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <g opacity="0.8">
                                                <path d="M3 8.25C3 6.17893 4.61177 4.5 6.6 4.5H17.4C19.3882 4.5 21 6.17893 21 8.25V13.875C21 15.9461 19.3882 17.625 17.4 17.625H8.4L3 19.5V8.25Z" />
                                                ...
                                                <path d="M6 12.75C6 12.3358 6.33579 12 6.75 12H14.25C14.6642 12 15 12.3358 15 12.75C15 13.1642 14.6642 13.5 14.25 13.5H6.75C6.33579 13.5 6 13.1642 6 12.75Z" fill="white" />
                                            </g>
                                        </svg>
                                    </li>
                                    <li class="contact-item icon-text icon-position-right instagram">
                                        <a href="https://www.instagram.com/seserahan_by_pings/" target="_blank" class="contact-link">
                                            ...
                                            <svg class="icon" width="24" height="24" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                                                <g opacity="0.8">
